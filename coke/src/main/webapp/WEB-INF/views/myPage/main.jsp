		...
		<div class="board_content">
			...
			<div class="board_content_wrapper">
				...
				<div class="board_content_list">
					...
					<div class="insertProfileBtn">
						<button class="ProfileBtn">사진 등록</button>
					</div>
					
					<form class="userIdAndName" action="/myPage/update" method="post">
						<input type="text" name="userid" value="${memberDto.userid}" readonly="readonly">
						<input type="text" name="userName" value="${memberDto.userName}">
						<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }">
						<button class="modifyBtn" type="submit">정보 수정</button>
					</form>
			...
			<div>
				<form class="actionForm" action="/myPage/main" method="get">
